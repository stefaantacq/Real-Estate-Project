...
export const TRANSLATIONS = {
  [Language.NL]: {
    ...
    renameVersion: 'Label toevoegen',
    toggleBookmark: 'Bookmark',
    versionRenamePopupTitle: 'Label toevoegen',
    versionRenameNewName: 'Naam voor label',
    versionRenamePlaceholder: 'Bijv. Bevat erfdienstbaarheid, Laatste concept...',
    ...
    compareOld: 'Oud',
    compareNew: 'Nieuw',
    compareUnified: 'Geïntegreerd',
    compareSplit: 'Gesplitst',
    compareAdded: 'Toegevoegd',
    compareRemoved: 'Verwijderd',
    compareSections: 'Secties',
    compareWords: 'woorden',
    compareSectionsChanged: 'secties',
    compareChanged: 'gewijzigd',
    compareUnchanged: 'Ongewijzigd',
    compareLoading: 'Versies laden...',
    compareDiffing: 'Versies vergelijken...',
    compareLoadError: 'Kon dossier niet laden.',
    compareDiffError: 'Kon versies niet vergelijken',
    compareSelectTwo: 'Selecteer twee verschillende versies',
    compareSelectTwoDesc: 'Kies hierboven een oude en een nieuwe versie om de wijzigingen te bekijken.',
    compareNotEnough: 'Niet genoeg versies',
    compareNotEnoughDesc: 'Er zijn minstens 2 versies nodig om te vergelijken. Maak een nieuwe versie aan via de dossier overzichtspagina.',
    compareSummary: 'van de',
    compareSummary2: 'secties zijn gewijzigd',
    compareWordsAdded: 'woorden toegevoegd',
  ...
  [Language.FR]: {
    ...
    renameVersion: 'Ajouter une étiquette',
    toggleBookmark: 'Signet',
    versionRenamePopupTitle: 'Ajouter une étiquette',
    versionRenameNewName: 'Nom de l\'étiquette',
    versionRenamePlaceholder: 'Ex. Brouillon final, Cas spécial...',
    ...
    compareOld: 'Ancien',
    compareNew: 'Nouveau',
    compareUnified: 'Intégré',
    compareSplit: 'Divisé',
    compareAdded: 'Ajouté',
    compareRemoved: 'Supprimé',
    compareSections: 'Sections',
    compareWords: 'mots',
    compareSectionsChanged: 'sections',
    compareChanged: 'modifié',
    compareUnchanged: 'Inchangé',
    compareLoading: 'Chargement des versions...',
    compareDiffing: 'Comparaison des versions...',
    compareLoadError: 'Impossible de charger le dossier.',
    compareDiffError: 'Impossible de comparer les versions',
    compareSelectTwo: 'Sélectionnez deux versions différentes',
    compareSelectTwoDesc: 'Choisissez une ancienne et une nouvelle version ci-dessus pour voir les modifications.',
    compareNotEnough: 'Pas assez de versions',
    compareNotEnoughDesc: 'Au moins 2 versions sont nécessaires pour comparer. Créez une nouvelle version depuis la page d\'aperçu du dossier.',
    compareSummary: 'sur',
    compareSummary2: 'sections ont été modifiées',
    compareWordsAdded: 'mots ajoutés',
  ...
  [Language.EN]: {
    ...
    renameVersion: 'Add label',
    toggleBookmark: 'Bookmark',
    versionRenamePopupTitle: 'Add label',
    versionRenameNewName: 'Name of label',
    versionRenamePlaceholder: 'E.g. Final draft, Special case...',
    ...
    compareLoading: 'Loading versions...',
    compareDiffing: 'Comparing versions...',
    compareLoadError: 'Could not load dossier.',
    compareDiffError: 'Could not compare versions',
    compareSelectTwo: 'Select two different versions',
    compareSelectTwoDesc: 'Choose an old and a new version above to see the changes.',
    compareNotEnough: 'Not enough versions',
    compareNotEnoughDesc: 'At least 2 versions are needed to compare. Create a new version from the dossier overview page.',
    compareSummary: 'of',
    compareSummary2: 'sections have changed',
    compareWordsAdded: 'words added',
