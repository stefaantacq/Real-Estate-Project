...
export const NewCompromise: React.FC<NewCompromiseProps> = ({ lang, onCancel, onComplete }) => {
  ...
  return (
    <div className="max-w-5xl mx-auto pb-20 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      {/* Page Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-slate-900 mb-2">{t.newCompromis}</h1>
        ...
        <div className="lg:col-span-8 space-y-8">
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-8 shadow-sm">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-xl font-bold text-slate-900">{t.dossierDetails}</h2>
            </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <input
                  type="text"
                  className="w-full bg-gray-50 border border-gray-300 rounded-lg px-4 py-3 text-slate-900 focus:ring-2 focus:ring-blue-500 outline-none"
              ...
              <div>
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:bg-gray-50 transition-colors relative cursor-pointer group">
                  ...
                  <div className="flex flex-col items-center pointer-events-none group-hover:scale-105 transition-transform">
                    ...
                    <p className="text-slate-900 font-medium text-lg">{t.dropzone}</p>
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm sticky top-6">
                ...
                return (
                  <div key={category} className="border border-gray-200 rounded-lg overflow-hidden">
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2">
                        <span className={`text-xs font-medium ${allPresent && presentCount > 0 ? 'text-green-600' : 'text-slate-500'}`}>
                    ...
                    {isExpanded && (
                      <div className="bg-white p-2">
                        {docs.map(doc => {
                          ...
                          return (
                            <div key={doc.id} className="flex items-center justify-between p-2 rounded hover:bg-gray-50 transition-colors">
                              <div className="flex items-center">
                                <div className={`w-2 h-2 rounded-full mr-3 ${isPresent ? 'bg-green-500' : 'bg-gray-300'}`}></div>
                                <span className={`text-xs ${isPresent ? 'text-slate-700 font-medium' : 'text-slate-400'}`}>
                                  {doc.label}
                                </span>
                              </div>
            ...
            <div className="border-t border-gray-100 pt-6">
              <button
                ...
                className="w-full bg-blue-600 hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed text-white py-4 rounded-xl font-bold shadow-lg shadow-blue-500/20 hover:shadow-blue-500/40 transition-all flex items-center justify-center group"
              >
                {isSubmitting ? (
                  <>
