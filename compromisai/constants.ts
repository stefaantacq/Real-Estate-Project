...
export const MOCK_SECTIONS: DocumentSection[] = [
  {
    id: 'sec1',
    title: 'Partijen',
    content: 'DE ONDERGETEKENDEN:\n\n1. De heer [placeholder:seller_firstname] [placeholder:seller_middlename] [placeholder:seller_lastname], geboren te [placeholder:seller_birthplace] op [placeholder:seller_birthdate], wonende te [placeholder:seller_address]. Hierna gezamenlijk genoemd "de verkoper".\n\n2. De heer [placeholder:buyer1_lastname] [placeholder:buyer1_firstname] [placeholder:buyer1_middlename], geboren te [placeholder:buyer1_birthplace] op [placeholder:buyer1_birthdate], en zijn echtgenote mevrouw [placeholder:buyer2_lastname] [placeholder:buyer2_firstname] [placeholder:buyer2_middlename], geboren te [placeholder:buyer2_birthplace] op [placeholder:buyer2_birthdate], samenwonende te [placeholder:buyers_address]. Gehuwd onder het beheer van de scheiding van goederen met beperkte gemeenschap. Hierna gezamenlijk genoemd "de koper".',
    isApproved: false,
    placeholders: [
      { id: 'p1', label: 'Voornaam verkoper', currentValue: 'Jeu Alfons', sourceDoc: 'huis.docx', sourcePage: 1, confidence: 'High', isApproved: false },
      { id: 'p2', label: 'Achternaam verkoper', currentValue: 'LENS', sourceDoc: 'huis.docx', sourcePage: 1, confidence: 'High', isApproved: false },
      { id: 'p3', label: 'Geboorteplaats verkoper', currentValue: 'Onze-Lieve-Vrouw-Waver', sourceDoc: 'huis.docx', sourcePage: 1, confidence: 'High', isApproved: false },
      { id: 'p4', label: 'Geboortedatum verkoper', currentValue: '17 juni 1931', sourceDoc: 'huis.docx', sourcePage: 1, confidence: 'High', isApproved: false },
      { id: 'p5', label: 'Adres verkoper', currentValue: 'Schaben, Wordenfreinstienen 4/2', sourceDoc: 'huis.docx', sourcePage: 1, confidence: 'High', isApproved: false },
      { id: 'p6', label: 'Achternaam koper 1', currentValue: 'VERELST', sourceDoc: 'huis.docx', sourcePage: 1, confidence: 'High', isApproved: false },
      { id: 'p7', label: 'Voornaam koper 1', currentValue: 'Stéphane Joseph Henri', sourceDoc: 'huis.docx', sourcePage: 1, confidence: 'High', isApproved: false },
      { id: 'p8', label: 'Geboorteplaats koper 1', currentValue: 'Mechelen', sourceDoc: 'huis.docx', sourcePage: 1, confidence: 'High', isApproved: false },
      { id: 'p9', label: 'Geboortedatum koper 1', currentValue: '16 augustus 1964', sourceDoc: 'huis.docx', sourcePage: 1, confidence: 'High', isApproved: false },
      { id: 'p10', label: 'Achternaam koper 2', currentValue: 'VAN AS', sourceDoc: 'huis.docx', sourcePage: 1, confidence: 'High', isApproved: false },
      { id: 'p11', label: 'Voornaam koper 2', currentValue: 'An Maria Walter', sourceDoc: 'huis.docx', sourcePage: 1, confidence: 'High', isApproved: false },
      { id: 'p12', label: 'Geboorteplaats koper 2', currentValue: 'Leuven', sourceDoc: 'huis.docx', sourcePage: 1, confidence: 'High', isApproved: false },
      { id: 'p13', label: 'Geboortedatum koper 2', currentValue: '21 januari 1976', sourceDoc: 'huis.docx', sourcePage: 1, confidence: 'High', isApproved: false },
      { id: 'p14', label: 'Adres kopers', currentValue: 'Sint-Katelijne-Waver (Onze-Lieve-Vrouw-Waver), Waverlaan 2', sourceDoc: 'huis.docx', sourcePage: 1, confidence: 'High', isApproved: false },
    ]
  },
  {
    id: 'sec2',
  ...
  },
  {
    ...
    isApproved: true,
    placeholders: [
      { id: 'p15', label: 'Gemeente eigendom', currentValue: 'SINT-KATELIJNE-WAVER', sourceDoc: 'huis.docx', sourcePage: 2, confidence: 'High', isApproved: true },
      { id: 'p16', label: 'Afdeling', currentValue: '3e afdeling', sourceDoc: 'huis.docx', sourcePage: 2, confidence: 'High', isApproved: true },
      { id: 'p17', label: 'Vroegere naam', currentValue: 'ONZE-LIEVE-VROUW-WAVER', sourceDoc: 'huis.docx', sourcePage: 2, confidence: 'High', isApproved: true },
      { id: 'p18', label: 'Straat eigendom', currentValue: 'Kegelslei', sourceDoc: 'huis.docx', sourcePage: 2, confidence: 'High', isApproved: true },
      { id: 'p19', label: 'Kadastrale sectie', currentValue: 'C', sourceDoc: 'huis.docx', sourcePage: 2, confidence: 'High', isApproved: true },
      { id: 'p20', label: 'Kadastraal nummer', currentValue: '98', sourceDoc: 'huis.docx', sourcePage: 2, confidence: 'High', isApproved: true },
      { id: 'p21', label: 'Grootte eigendom', currentValue: 'één hectare vier are drieëndertig centiare (01 ha 04 a 33 ca)', sourceDoc: 'huis.docx', sourcePage: 2, confidence: 'High', isApproved: true },
    ]
  },
  {
    id: 'sec4',
  ...
  },
  {
    ...
    isApproved: false,
    placeholders: [
      { id: 'p22', label: 'Gewestplan', currentValue: 'Mechelen', sourceDoc: 'huis.docx', sourcePage: 4, confidence: 'High', isApproved: false },
      { id: 'p23', label: 'Bestemming', currentValue: 'agrarisch gebied', sourceDoc: 'huis.docx', sourcePage: 4, confidence: 'High', isApproved: false },
    ]
  },
  {
    id: 'sec7',
  ...
  },
  {
    ...
    isApproved: false,
    placeholders: [
      { id: 'p24', label: 'Verkoopprijs (woorden)', currentValue: 'VIERENTWINTIGDUIZEND VIJFHONDERD EURO', sourceDoc: 'huis.docx', sourcePage: 5, confidence: 'High', isApproved: false },
      { id: 'p25', label: 'Verkoopprijs (cijfers)', currentValue: '24.500,00 EUR', sourceDoc: 'huis.docx', sourcePage: 5, confidence: 'High', isApproved: false },
      { id: 'p26', label: 'Waarborgbedrag (woorden)', currentValue: 'TWEEDUIZEND VIERHONDERDVIJFTIG EURO', sourceDoc: 'huis.docx', sourcePage: 5, confidence: 'High', isApproved: false },
      { id: 'p27', label: 'Waarborgbedrag (cijfers)', currentValue: '2.450,00 EUR', sourceDoc: 'huis.docx', sourcePage: 5, confidence: 'High', isApproved: false },
      { id: 'p28', label: 'Rekeningnummer notaris', currentValue: '230-0122700-15', sourceDoc: 'huis.docx', sourcePage: 5, confidence: 'High', isApproved: false },
      { id: 'p29', label: 'Naam notaris', currentValue: 'André Costa', sourceDoc: 'huis.docx', sourcePage: 5, confidence: 'High', isApproved: false },
    ]
  },
  {
    id: 'sec9',
  ...
  },
  {
    ...
    isApproved: false,
    placeholders: [
      { id: 'p32', label: 'Plaats ondertekening', currentValue: 'Sint-Katelijne-Waver (Onze-Lieve-Vrouw-Waver)', sourceDoc: 'huis.docx', sourcePage: 8, confidence: 'High', isApproved: false },
      { id: 'p33', label: 'Datum ondertekening', currentValue: '26 februari 2003', sourceDoc: 'huis.docx', sourcePage: 8, confidence: 'High', isApproved: false },
    ]
  }
];
